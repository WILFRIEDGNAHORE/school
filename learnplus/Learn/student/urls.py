...
urlpatterns = [
    ...
    path('custom_messages/<str:classe>/', views.custom_messages, name='custom_messages'),
    ...
    path('skip_question/<int:quiz_id>/<int:question_id>/', views.skip_question, name='skip_question'),
